...
# Удаляем папку instance полностью
instance_path = 'instance'
if os.path.exists(instance_path):
    shutil.rmtree(instance_path)
    print(f"✓ Папка {instance_path} удалена")

# Удаляем базу в корне, если есть
if os.path.exists('ssanych.db'):
    os.remove('ssanych.db')
    print("✓ База в корневой папке удалена")
...
with app.app_context():
    ...
    print("📍 База находится в: instance/ssanych.db")
